...
__instruction ADDIW_0
    __encoding ADDIW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), eq_int(xlen, 64))
        __decode
...
__instruction AES32DSI_0
    __encoding AES32DSI_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zknd), eq_int(xlen, 32)))
        __decode
...
__instruction AES32ESI_0
    __encoding AES32ESI_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zkne), eq_int(xlen, 32)))
        __decode
...
__instruction AES64DS_0
    __encoding AES64DS_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zknd), eq_int(xlen, 64)))
        __decode
...
__instruction AES64ES_0
    __encoding AES64ES_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zkne), eq_int(xlen, 64)))
        __decode
...
__instruction AES64IM_0
    __encoding AES64IM_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_Zknd), eq_int(xlen, 64)))
        __decode
...
__instruction AES64KS1I_0
    __encoding AES64KS1I_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(or_bool(currentlyEnabled(Ext_Zkne), currentlyEnabled(Ext_Zknd)), and_bool(eq_int(xlen, 64), ult_bits(rnum, '1011'))))
        __decode
...
__instruction AES64KS2_0
    __encoding AES64KS2_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(or_bool(currentlyEnabled(Ext_Zkne), currentlyEnabled(Ext_Zknd)), eq_int(xlen, 64)))
        __decode
...
__instruction AMO_0
    __encoding AMO_0
        ...
        __guard and_bool(and_bool(encdec_amoop_backwards_matches(op), and_bool(bool_bits_backwards_matches(aq), and_bool(bool_bits_backwards_matches(rl), and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(size_enc_backwards_matches(size), encdec_reg_backwards_matches(rd))))))), and_bool(currentlyEnabled(Ext_Zaamo), amo_width_valid(size_enc_backwards(size))))
        __decode


    __execute
        constant amoop op = encdec_amoop_backwards(op);
        constant boolean aq = bool_bits_backwards(aq);
        constant boolean rl = bool_bits_backwards(rl);
        constant bits(5) rs2 = encdec_reg_backwards(rs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
...
__instruction BREV8_0
    __encoding BREV8_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_Zbkb))
        __decode
...
__instruction BTYPE_0
    __encoding BTYPE_0
        ...
        __guard and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_bop_backwards_matches(op)))
        __decode
...
__instruction CLMUL_0
    __encoding CLMUL_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), or_bool(currentlyEnabled(Ext_Zbc), currentlyEnabled(Ext_Zbkc)))
        __decode
...
__instruction CLMULR_0
    __encoding CLMULR_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zbc))
        __decode
...
__instruction CLZ_0
    __encoding CLZ_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_Zbb))
        __decode
...
__instruction CLZW_0
    __encoding CLZW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_Zbb), eq_int(xlen, 64)))
        __decode
...
__instruction CSRImm_0
    __encoding CSRImm_0
        ...
        __guard and_bool(and_bool(encdec_csrop_backwards_matches(op), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_Zicsr))
        __decode
...
__instruction CSRReg_0
    __encoding CSRReg_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_csrop_backwards_matches(op), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zicsr))
        __decode
...
__instruction DIV_0
    __encoding DIV_0
        ...
        __field rs2 20 +: 5
        __field rs1 15 +: 5
        __field is_unsigned 12 +: 1
        __field rd 7 +: 5
        __opcode '0000001xxxxxxxxxx10xxxxxx0110011'
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(bool_bits_backwards_matches(is_unsigned), encdec_reg_backwards_matches(rd)))), currentlyEnabled(Ext_M))
        __decode
...
__instruction DIVW_0
    __encoding DIVW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(bool_bits_backwards_matches(is_unsigned), encdec_reg_backwards_matches(rd)))), and_bool(eq_int(xlen, 64), currentlyEnabled(Ext_M)))
        __decode
...
__instruction FCVTMOD_W_D_0
    __encoding FCVTMOD_W_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_D), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FENCEI_RESERVED_0
    __encoding FENCEI_RESERVED_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs), encdec_reg_backwards_matches(rd)), or_bool(neq_bits(imm, '000000000000'), or_bool(encdec_reg_backwards(rs) != zreg, encdec_reg_backwards(rd) != zreg)))
        __decode
...
__instruction FENCE_RESERVED_0
    __encoding FENCE_RESERVED_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs), encdec_reg_backwards_matches(rd)), or_bool(and_bool(neq_bits(fm, '0000'), neq_bits(fm, '1000')), or_bool(encdec_reg_backwards(rs) != zreg, encdec_reg_backwards(rd) != zreg)))
        __decode
...
__instruction FLEQ_D_0
    __encoding FLEQ_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_D), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FLEQ_H_0
    __encoding FLEQ_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zfh), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FLEQ_S_0
    __encoding FLEQ_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zfa))
        __decode
...
__instruction FLI_D_0
    __encoding FLI_D_0
        ...
        __guard and_bool(encdec_freg_backwards_matches(rd), and_bool(currentlyEnabled(Ext_D), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FLI_H_0
    __encoding FLI_H_0
        ...
        __guard and_bool(encdec_freg_backwards_matches(rd), and_bool(currentlyEnabled(Ext_Zfh), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FLI_S_0
    __encoding FLI_S_0
        ...
        __guard and_bool(encdec_freg_backwards_matches(rd), currentlyEnabled(Ext_Zfa))
        __decode
...
__instruction FMAXM_D_0
    __encoding FMAXM_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_freg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_D), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FMAXM_H_0
    __encoding FMAXM_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_freg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zfh), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FMAXM_S_0
    __encoding FMAXM_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_freg_backwards_matches(rd))), currentlyEnabled(Ext_Zfa))
        __decode
...
__instruction FMVH_X_D_0
    __encoding FMVH_X_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_D), and_bool(currentlyEnabled(Ext_Zfa), in32BitMode())))
        __decode
...
__instruction FMVP_D_X_0
    __encoding FMVP_D_X_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_freg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_D), and_bool(currentlyEnabled(Ext_Zfa), in32BitMode())))
        __decode
...
__instruction FROUNDNX_D_0
    __encoding FROUNDNX_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_D), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FROUNDNX_H_0
    __encoding FROUNDNX_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zfh), currentlyEnabled(Ext_Zfa)))
        __decode
...
__instruction FROUNDNX_S_0
    __encoding FROUNDNX_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), currentlyEnabled(Ext_Zfa))
        __decode
...
__instruction FVFMATYPE_0
    __encoding FVFMATYPE_0
        ...
        __guard and_bool(and_bool(encdec_fvfmafunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fvfmafunct6 funct6 = encdec_fvfmafunct6_backwards(funct6);
...
__instruction FVFMTYPE_0
    __encoding FVFMTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx101xxxxx1010111'
        __guard and_bool(and_bool(encdec_fvfmfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fvfmfunct6 funct6 = encdec_fvfmfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_freg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FVFTYPE_0
    __encoding FVFTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx101xxxxx1010111'
        __guard and_bool(and_bool(encdec_fvffunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fvffunct6 funct6 = encdec_fvffunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_freg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FVVMATYPE_0
    __encoding FVVMATYPE_0
        ...
        __guard and_bool(and_bool(encdec_fvvmafunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fvvmafunct6 funct6 = encdec_fvvmafunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
...
__instruction FVVMTYPE_0
    __encoding FVVMTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_fvvmfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fvvmfunct6 funct6 = encdec_fvvmfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FVVTYPE_0
    __encoding FVVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_fvvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fvvfunct6 funct6 = encdec_fvvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FWFTYPE_0
    __encoding FWFTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx101xxxxx1010111'
        __guard and_bool(and_bool(encdec_fwffunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fwffunct6 funct6 = encdec_fwffunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_freg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FWVFMATYPE_0
    __encoding FWVFMATYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx101xxxxx1010111'
        __guard and_bool(and_bool(encdec_fwvfmafunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fwvfmafunct6 funct6 = encdec_fwvfmafunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_freg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FWVFTYPE_0
    __encoding FWVFTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx101xxxxx1010111'
        __guard and_bool(and_bool(encdec_fwvffunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fwvffunct6 funct6 = encdec_fwvffunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_freg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FWVTYPE_0
    __encoding FWVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_fwvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fwvfunct6 funct6 = encdec_fwvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FWVVMATYPE_0
    __encoding FWVVMATYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_fwvvmafunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs1), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fwvvmafunct6 funct6 = encdec_fwvvmafunct6_backwards(funct6);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction FWVVTYPE_0
    __encoding FWVVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_fwvvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant fwvvfunct6 funct6 = encdec_fwvvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction F_BIN_F_TYPE_D_0
    __encoding F_BIN_F_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_freg_backwards_matches(rd))), and_bool(haveDoubleFPU(), validDoubleRegs(3, encdec_freg_backwards(rd):encdec_freg_backwards(rs1):encdec_freg_backwards(rs2))))
        __decode
...
__instruction F_BIN_F_TYPE_H_0
    __encoding F_BIN_F_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_freg_backwards_matches(rd))), haveHalfFPU())
        __decode
...
__instruction F_BIN_RM_TYPE_D_0
    __encoding F_BIN_RM_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd)))), and_bool(haveDoubleFPU(), validDoubleRegs(3, encdec_freg_backwards(rd):encdec_freg_backwards(rs1):encdec_freg_backwards(rs2))))
        __decode
...
__instruction F_BIN_RM_TYPE_H_0
    __encoding F_BIN_RM_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd)))), haveHalfFPU())
        __decode
...
__instruction F_BIN_RM_TYPE_S_0
    __encoding F_BIN_RM_TYPE_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd)))), haveSingleFPU())
        __decode
...
__instruction F_BIN_TYPE_F_S_0
    __encoding F_BIN_TYPE_F_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_freg_backwards_matches(rd))), haveSingleFPU())
        __decode
...
__instruction F_BIN_TYPE_X_S_0
    __encoding F_BIN_TYPE_X_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), haveSingleFPU())
        __decode
...
__instruction F_BIN_X_TYPE_D_0
    __encoding F_BIN_X_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(haveDoubleFPU(), validDoubleRegs(2, encdec_freg_backwards(rs1):encdec_freg_backwards(rs2))))
        __decode
...
__instruction F_BIN_X_TYPE_H_0
    __encoding F_BIN_X_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), haveHalfFPU())
        __decode
...
__instruction F_MADD_TYPE_D_0
    __encoding F_MADD_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs3), and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))))), and_bool(haveDoubleFPU(), validDoubleRegs(4, encdec_freg_backwards(rd):encdec_freg_backwards(rs1):encdec_freg_backwards(rs2):encdec_freg_backwards(rs3))))
        __decode


    __execute
        constant bits(5) rs3 = encdec_freg_backwards(rs3);
        constant bits(5) rs2 = encdec_freg_backwards(rs2);
        constant bits(5) rs1 = encdec_freg_backwards(rs1);
        constant rounding_mode rm = encdec_rounding_mode_backwards(rm);
        constant bits(5) rd = encdec_freg_backwards(rd);
...
__instruction F_MADD_TYPE_H_0
    __encoding F_MADD_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs3), and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))))), haveHalfFPU())
        __decode
...
__instruction F_MADD_TYPE_S_0
    __encoding F_MADD_TYPE_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs3), and_bool(encdec_freg_backwards_matches(rs2), and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))))), haveSingleFPU())
        __decode
...
__instruction F_UN_F_TYPE_D_0
    __encoding F_UN_F_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_freg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_D), gteq_int(xlen, 64)))
        __decode
...
__instruction F_UN_F_TYPE_H_0
    __encoding F_UN_F_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_freg_backwards_matches(rd)), currentlyEnabled(Ext_Zfhmin))
        __decode
...
__instruction F_UN_RM_FF_TYPE_D_0
    __encoding F_UN_RM_FF_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveDoubleFPU(), validDoubleRegs(1, encdec_freg_backwards(rd))))
        __decode
...
__instruction F_UN_RM_FF_TYPE_D_1
    __encoding F_UN_RM_FF_TYPE_D_1
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveDoubleFPU(), validDoubleRegs(1, encdec_freg_backwards(rs1))))
        __decode
...
__instruction F_UN_RM_FF_TYPE_D_2
    __encoding F_UN_RM_FF_TYPE_D_2
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveDoubleFPU(), validDoubleRegs(2, encdec_freg_backwards(rd):encdec_freg_backwards(rs1))))
        __decode
...
__instruction F_UN_RM_FF_TYPE_H_0
    __encoding F_UN_RM_FF_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveHalfMin(), and_bool(haveDoubleFPU(), validDoubleRegs(1, encdec_freg_backwards(rd)))))
        __decode
...
__instruction F_UN_RM_FF_TYPE_H_1
    __encoding F_UN_RM_FF_TYPE_H_1
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), haveHalfMin())
        __decode
...
__instruction F_UN_RM_FF_TYPE_H_2
    __encoding F_UN_RM_FF_TYPE_H_2
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveHalfMin(), and_bool(haveDoubleFPU(), validDoubleRegs(1, encdec_freg_backwards(rs1)))))
        __decode
...
__instruction F_UN_RM_FF_TYPE_H_4
    __encoding F_UN_RM_FF_TYPE_H_4
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), haveHalfFPU())
        __decode
...
__instruction F_UN_RM_FF_TYPE_S_0
    __encoding F_UN_RM_FF_TYPE_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), haveSingleFPU())
        __decode
...
__instruction F_UN_RM_FX_TYPE_D_0
    __encoding F_UN_RM_FX_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_reg_backwards_matches(rd))), and_bool(haveDoubleFPU(), gteq_int(xlen, 64)))
        __decode
...
__instruction F_UN_RM_FX_TYPE_D_2
    __encoding F_UN_RM_FX_TYPE_D_2
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_reg_backwards_matches(rd))), and_bool(haveDoubleFPU(), validDoubleRegs(1, encdec_freg_backwards(rs1))))
        __decode
...
__instruction F_UN_RM_FX_TYPE_H_0
    __encoding F_UN_RM_FX_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_reg_backwards_matches(rd))), and_bool(haveHalfFPU(), gteq_int(xlen, 64)))
        __decode
...
__instruction F_UN_RM_FX_TYPE_H_2
    __encoding F_UN_RM_FX_TYPE_H_2
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_reg_backwards_matches(rd))), haveHalfFPU())
        __decode
...
__instruction F_UN_RM_FX_TYPE_S_0
    __encoding F_UN_RM_FX_TYPE_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_reg_backwards_matches(rd))), and_bool(haveSingleFPU(), gteq_int(xlen, 64)))
        __decode
...
__instruction F_UN_RM_FX_TYPE_S_2
    __encoding F_UN_RM_FX_TYPE_S_2
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_reg_backwards_matches(rd))), haveSingleFPU())
        __decode
...
__instruction F_UN_RM_XF_TYPE_D_0
    __encoding F_UN_RM_XF_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveDoubleFPU(), gteq_int(xlen, 64)))
        __decode
...
__instruction F_UN_RM_XF_TYPE_D_2
    __encoding F_UN_RM_XF_TYPE_D_2
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveDoubleFPU(), validDoubleRegs(1, encdec_freg_backwards(rd))))
        __decode
...
__instruction F_UN_RM_XF_TYPE_H_0
    __encoding F_UN_RM_XF_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveHalfFPU(), gteq_int(xlen, 64)))
        __decode
...
__instruction F_UN_RM_XF_TYPE_H_2
    __encoding F_UN_RM_XF_TYPE_H_2
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), haveHalfFPU())
        __decode
...
__instruction F_UN_RM_XF_TYPE_S_0
    __encoding F_UN_RM_XF_TYPE_S_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), and_bool(haveSingleFPU(), gteq_int(xlen, 64)))
        __decode
...
__instruction F_UN_RM_XF_TYPE_S_2
    __encoding F_UN_RM_XF_TYPE_S_2
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_rounding_mode_backwards_matches(rm), encdec_freg_backwards_matches(rd))), haveSingleFPU())
        __decode
...
__instruction F_UN_TYPE_F_S_0
    __encoding F_UN_TYPE_F_S_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_freg_backwards_matches(rd)), currentlyEnabled(Ext_F))
        __decode
...
__instruction F_UN_TYPE_X_S_0
    __encoding F_UN_TYPE_X_S_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_F))
        __decode
...
__instruction F_UN_TYPE_X_S_1
    __encoding F_UN_TYPE_X_S_1
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), haveSingleFPU())
        __decode
...
__instruction F_UN_X_TYPE_D_0
    __encoding F_UN_X_TYPE_D_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_D), gteq_int(xlen, 64)))
        __decode
...
__instruction F_UN_X_TYPE_D_1
    __encoding F_UN_X_TYPE_D_1
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(haveDoubleFPU(), validDoubleRegs(1, encdec_freg_backwards(rs1))))
        __decode
...
__instruction F_UN_X_TYPE_H_0
    __encoding F_UN_X_TYPE_H_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_Zfhmin))
        __decode
...
__instruction F_UN_X_TYPE_H_1
    __encoding F_UN_X_TYPE_H_1
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), haveHalfFPU())
        __decode
...
__instruction ITYPE_0
    __encoding ITYPE_0
        ...
        __guard and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_iop_backwards_matches(op), encdec_reg_backwards_matches(rd)))
        __decode
...
__instruction JAL_0
    __encoding JAL_0
        ...
        __guard encdec_reg_backwards_matches(rd)
        __decode
...
__instruction JALR_0
    __encoding JALR_0
        ...
        __guard and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))
        __decode
...
__instruction LOAD_0
    __encoding LOAD_0
        ...
        __field imm 20 +: 12
        __field rs1 15 +: 5
        __field is_unsigned 14 +: 1
        __field width 12 +: 2
        __field rd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxxxxxxxxxx0000011'
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(bool_bits_backwards_matches(is_unsigned), and_bool(size_enc_backwards_matches(width), encdec_reg_backwards_matches(rd)))), valid_load_encdec(size_enc_backwards(width), bool_bits_backwards(is_unsigned)))
        __decode
...
__instruction LOADRES_0
    __encoding LOADRES_0
        ...
        __guard and_bool(and_bool(bool_bits_backwards_matches(aq), and_bool(bool_bits_backwards_matches(rl), and_bool(encdec_reg_backwards_matches(rs1), and_bool(size_enc_backwards_matches(size), encdec_reg_backwards_matches(rd))))), and_bool(currentlyEnabled(Ext_Zalrsc), lrsc_width_valid(size_enc_backwards(size))))
        __decode
...
__instruction LOAD_FP_0
    __encoding LOAD_FP_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_freg_backwards_matches(rd)), currentlyEnabled(Ext_D))
        __decode
...
__instruction MASKTYPEI_0
    __encoding MASKTYPEI_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), currentlyEnabled(Ext_V))
        __decode
...
__instruction MASKTYPEV_0
    __encoding MASKTYPEV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction MASKTYPEX_0
    __encoding MASKTYPEX_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction MMTYPE_0
    __encoding MMTYPE_0
        ...
        __guard and_bool(and_bool(encdec_mmfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant mmfunct6 funct6 = encdec_mmfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction MOVETYPEI_0
    __encoding MOVETYPEI_0
        ...
        __guard and_bool(encdec_vreg_backwards_matches(vd), currentlyEnabled(Ext_V))
        __decode
...
__instruction MOVETYPEV_0
    __encoding MOVETYPEV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)), currentlyEnabled(Ext_V))
        __decode
...
__instruction MOVETYPEX_0
    __encoding MOVETYPEX_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)), currentlyEnabled(Ext_V))
        __decode
...
__instruction MUL_0
    __encoding MUL_0
        ...
        __field rs2 20 +: 5
        __field rs1 15 +: 5
        __field mul_opXN 12 +: 3
        __field rd 7 +: 5
        __opcode '0000001xxxxxxxxxxxxxxxxxx0110011'
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_mul_op_backwards_matches(mul_opXN), encdec_reg_backwards_matches(rd)))), or_bool(currentlyEnabled(Ext_M), currentlyEnabled(Ext_Zmmul)))
        __decode
...
__instruction MULW_0
    __encoding MULW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(eq_int(xlen, 64), or_bool(currentlyEnabled(Ext_M), currentlyEnabled(Ext_Zmmul))))
        __decode
...
__instruction MVVMATYPE_0
    __encoding MVVMATYPE_0
        ...
        __guard and_bool(and_bool(encdec_mvvmafunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant mvvmafunct6 funct6 = encdec_mvvmafunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction MVVTYPE_0
    __encoding MVVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx010xxxxx1010111'
        __guard and_bool(and_bool(encdec_mvvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant mvvfunct6 funct6 = encdec_mvvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction MVXMATYPE_0
    __encoding MVXMATYPE_0
        ...
        __guard and_bool(and_bool(encdec_mvxmafunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant mvxmafunct6 funct6 = encdec_mvxmafunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction MVXTYPE_0
    __encoding MVXTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx110xxxxx1010111'
        __guard and_bool(and_bool(encdec_mvxfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant mvxfunct6 funct6 = encdec_mvxfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction NISTYPE_0
    __encoding NISTYPE_0
        ...
        __guard and_bool(and_bool(encdec_nisfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction NITYPE_0
    __encoding NITYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx011xxxxx1010111'
        __guard and_bool(and_bool(encdec_nifunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction NVSTYPE_0
    __encoding NVSTYPE_0
        ...
        __guard and_bool(and_bool(encdec_nvsfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant nvsfunct6 funct6 = encdec_nvsfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction NVTYPE_0
    __encoding NVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx000xxxxx1010111'
        __guard and_bool(and_bool(encdec_nvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant nvfunct6 funct6 = encdec_nvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction NXSTYPE_0
    __encoding NXSTYPE_0
        ...
        __guard and_bool(and_bool(encdec_nxsfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant nxsfunct6 funct6 = encdec_nxsfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction NXTYPE_0
    __encoding NXTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx100xxxxx1010111'
        __guard and_bool(and_bool(encdec_nxfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant nxfunct6 funct6 = encdec_nxfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction REV8_0
    __encoding REV8_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(or_bool(currentlyEnabled(Ext_Zbb), currentlyEnabled(Ext_Zbkb)), eq_int(xlen, 64)))
        __decode
...
__instruction REV8_1
    __encoding REV8_1
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(or_bool(currentlyEnabled(Ext_Zbb), currentlyEnabled(Ext_Zbkb)), eq_int(xlen, 32)))
        __decode
...
__instruction RFVVTYPE_0
    __encoding RFVVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_rfvvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant rfvvfunct6 funct6 = encdec_rfvvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction RIVVTYPE_0
    __encoding RIVVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx000xxxxx1010111'
        __guard and_bool(and_bool(encdec_rivvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant rivvfunct6 funct6 = encdec_rivvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction RMVVTYPE_0
    __encoding RMVVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx010xxxxx1010111'
        __guard and_bool(and_bool(encdec_rmvvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant rmvvfunct6 funct6 = encdec_rmvvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction RORI_0
    __encoding RORI_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(or_bool(currentlyEnabled(Ext_Zbb), currentlyEnabled(Ext_Zbkb)), or_bool(eq_int(xlen, 64), eq_bit(bitvector_access(shamt, 5), '0'))))
        __decode
...
__instruction RTYPE_0
    __encoding RTYPE_0
        ...
        __guard and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)))
        __decode
...
__instruction RTYPEW_0
    __encoding RTYPEW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), eq_int(xlen, 64))
        __decode
...
__instruction SFENCE_VMA_0
    __encoding SFENCE_VMA_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), encdec_reg_backwards_matches(rs1)), or_bool(virtual_memory_supported(), not(TRUE)))
        __decode
...
__instruction SHA256SIG0_0
    __encoding SHA256SIG0_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_Zknh))
        __decode
...
__instruction SHA512SIG0_0
    __encoding SHA512SIG0_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_Zknh), eq_int(xlen, 64)))
        __decode
...
__instruction SHA512SIG0H_0
    __encoding SHA512SIG0H_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zknh), eq_int(xlen, 32)))
        __decode
...
__instruction SHIFTIOP_0
    __encoding SHIFTIOP_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), or_bool(eq_int(xlen, 64), eq_bit(bitvector_access(shamt, 5), '0')))
        __decode
...
__instruction SINVAL_VMA_0
    __encoding SINVAL_VMA_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), encdec_reg_backwards_matches(rs1)), currentlyEnabled(Ext_Svinval))
        __decode
...
__instruction SLLIUW_0
    __encoding SLLIUW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_Zba), eq_int(xlen, 64)))
        __decode
...
__instruction SM3P0_0
    __encoding SM3P0_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_Zksh))
        __decode
...
__instruction SM4ED_0
    __encoding SM4ED_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zksed))
        __decode
...
__instruction STORE_0
    __encoding STORE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), size_enc_backwards_matches(width))), lteq_int(size_bytes_forwards(size_enc_backwards(width)), xlen_bytes))
        __decode
...
__instruction STORECON_0
    __encoding STORECON_0
        ...
        __guard and_bool(and_bool(bool_bits_backwards_matches(aq), and_bool(bool_bits_backwards_matches(rl), and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(size_enc_backwards_matches(size), encdec_reg_backwards_matches(rd)))))), and_bool(currentlyEnabled(Ext_Zalrsc), lrsc_width_valid(size_enc_backwards(size))))
        __decode
...
__instruction STORE_FP_0
    __encoding STORE_FP_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), encdec_reg_backwards_matches(rs1)), currentlyEnabled(Ext_D))
        __decode
...
__instruction STORE_FP_1
    __encoding STORE_FP_1
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), encdec_reg_backwards_matches(rs1)), currentlyEnabled(Ext_F))
        __decode
...
__instruction STORE_FP_2
    __encoding STORE_FP_2
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs2), encdec_reg_backwards_matches(rs1)), currentlyEnabled(Ext_Zfhmin))
        __decode
...
__instruction UNZIP_0
    __encoding UNZIP_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_Zbkb), eq_int(xlen, 32)))
        __decode
...
__instruction UTYPE_0
    __encoding UTYPE_0
        ...
        __guard and_bool(encdec_reg_backwards_matches(rd), encdec_uop_backwards_matches(op))
        __decode
...
__instruction VAESDF_0
    __encoding VAESDF_0
        ...
        __guard and_bool(and_bool(encdec_vaesdf_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), and_bool(currentlyEnabled(Ext_Zvkned), and_bool(eq_int(get_sew(), 32), and_bool(zvk_check_encdec(128, 4), or_bool(encdec_vaesdf_backwards(funct6) == ZVK_VAESDF_VV, zvk_valid_reg_overlap(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vd), get_lmul_pow()))))))
        __decode
...
__instruction VAESDM_0
    __encoding VAESDM_0
        ...
        __guard and_bool(and_bool(encdec_vaesdm_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), and_bool(currentlyEnabled(Ext_Zvkned), and_bool(eq_int(get_sew(), 32), and_bool(zvk_check_encdec(128, 4), or_bool(encdec_vaesdm_backwards(funct6) == ZVK_VAESDM_VV, zvk_valid_reg_overlap(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vd), get_lmul_pow()))))))
        __decode
...
__instruction VAESEF_0
    __encoding VAESEF_0
        ...
        __guard and_bool(and_bool(encdec_vaesef_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), and_bool(currentlyEnabled(Ext_Zvkned), and_bool(eq_int(get_sew(), 32), and_bool(zvk_check_encdec(128, 4), or_bool(encdec_vaesef_backwards(funct6) == ZVK_VAESEF_VV, zvk_valid_reg_overlap(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vd), get_lmul_pow()))))))
        __decode
...
__instruction VAESEM_0
    __encoding VAESEM_0
        ...
        __guard and_bool(and_bool(encdec_vaesem_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), and_bool(currentlyEnabled(Ext_Zvkned), and_bool(eq_int(get_sew(), 32), and_bool(zvk_check_encdec(128, 4), or_bool(encdec_vaesem_backwards(funct6) == ZVK_VAESEM_VV, zvk_valid_reg_overlap(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vd), get_lmul_pow()))))))
        __decode
...
__instruction VAESKF1_VI_0
    __encoding VAESKF1_VI_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), and_bool(currentlyEnabled(Ext_Zvkned), and_bool(eq_int(get_sew(), 32), zvk_check_encdec(128, 4))))
        __decode
...
__instruction VAESZ_VS_0
    __encoding VAESZ_VS_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), and_bool(currentlyEnabled(Ext_Zvkned), and_bool(eq_int(get_sew(), 32), and_bool(zvk_check_encdec(128, 4), zvk_valid_reg_overlap(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vd), get_lmul_pow())))))
        __decode
...
__instruction VANDN_VV_0
    __encoding VANDN_VV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_Zvkb))
        __decode
...
__instruction VANDN_VX_0
    __encoding VANDN_VX_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_Zvkb))
        __decode
...
__instruction VBREV8_V_0
    __encoding VBREV8_V_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), currentlyEnabled(Ext_Zvkb))
        __decode
...
__instruction VBREV_V_0
    __encoding VBREV_V_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), currentlyEnabled(Ext_Zvbb))
        __decode
...
__instruction VCLMULH_VV_0
    __encoding VCLMULH_VV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd))), and_bool(currentlyEnabled(Ext_Zvbc), eq_int(get_sew(), 64)))
        __decode
...
__instruction VCLMULH_VX_0
    __encoding VCLMULH_VX_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd))), and_bool(currentlyEnabled(Ext_Zvbc), eq_int(get_sew(), 64)))
        __decode
...
__instruction VCPOP_M_0
    __encoding VCPOP_M_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_V))
        __decode
...
__instruction VEXT2TYPE_0
    __encoding VEXT2TYPE_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(vext2_vs1_backwards_matches(funct6), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VEXT4TYPE_0
    __encoding VEXT4TYPE_0
        ...
        __field vd 7 +: 5
        __opcode '010010xxxxxxxxxxx010xxxxx1010111'
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(vext4_vs1_backwards_matches(funct6), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VEXT8TYPE_0
    __encoding VEXT8TYPE_0
        ...
        __field vd 7 +: 5
        __opcode '010010xxxxxxxxxxx010xxxxx1010111'
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(vext8_vs1_backwards_matches(funct6), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VFMERGE_0
    __encoding VFMERGE_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_freg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VFMV_0
    __encoding VFMV_0
        ...
        __guard and_bool(and_bool(encdec_freg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)), currentlyEnabled(Ext_V))
        __decode
...
__instruction VFMVFS_0
    __encoding VFMVFS_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_freg_backwards_matches(rd)), currentlyEnabled(Ext_V))
        __decode
...
__instruction VFNUNARY0_0
    __encoding VFNUNARY0_0
        ...
        __field vm 25 +: 1
        __field vs2 20 +: 5
        __field vfnunary0XN 15 +: 5
        __field vd 7 +: 5
        __opcode '010010xxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vfnunary0_vs1_backwards_matches(vfnunary0XN), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VFUNARY0_0
    __encoding VFUNARY0_0
        ...
        __field vm 25 +: 1
        __field vs2 20 +: 5
        __field vfunary0XN 15 +: 5
        __field vd 7 +: 5
        __opcode '010010xxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vfunary0_vs1_backwards_matches(vfunary0XN), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VFUNARY1_0
    __encoding VFUNARY1_0
        ...
        __field vm 25 +: 1
        __field vs2 20 +: 5
        __field vfunary1XN 15 +: 5
        __field vd 7 +: 5
        __opcode '010011xxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vfunary1_vs1_backwards_matches(vfunary1XN), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VFWUNARY0_0
    __encoding VFWUNARY0_0
        ...
        __field vm 25 +: 1
        __field vs2 20 +: 5
        __field vfwunary0XN 15 +: 5
        __field vd 7 +: 5
        __opcode '010010xxxxxxxxxxx001xxxxx1010111'
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vfwunary0_vs1_backwards_matches(vfwunary0XN), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VGHSH_VV_0
    __encoding VGHSH_VV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd))), and_bool(currentlyEnabled(Ext_Zvkg), and_bool(eq_int(get_sew(), 32), zvk_check_encdec(128, 4))))
        __decode
...
__instruction VGMUL_VV_0
    __encoding VGMUL_VV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), and_bool(currentlyEnabled(Ext_Zvkg), and_bool(eq_int(get_sew(), 32), zvk_check_encdec(128, 4))))
        __decode
...
__instruction VICMPTYPE_0
    __encoding VICMPTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx011xxxxx1010111'
        __guard and_bool(and_bool(encdec_vicmpfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VIMCTYPE_0
    __encoding VIMCTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vimcfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VIMSTYPE_0
    __encoding VIMSTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vimsfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VIMTYPE_0
    __encoding VIMTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxx0xxxxxxxxxx011xxxxx1010111'
        __guard and_bool(and_bool(encdec_vimfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VISG_0
    __encoding VISG_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx011xxxxx1010111'
        __guard and_bool(and_bool(encdec_visgfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VITYPE_0
    __encoding VITYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx011xxxxx1010111'
        __guard and_bool(and_bool(encdec_vifunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VLOXSEGTYPE_0
    __encoding VLOXSEGTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_vlewidth_backwards_matches(width), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VLRETYPE_0
    __encoding VLRETYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_vlewidth_backwards_matches(width), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VLSSEGTYPE_0
    __encoding VLSSEGTYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_vlewidth_backwards_matches(width), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VMTYPE_0
    __encoding VMTYPE_0
        __instruction_set R64
        __field rs1 15 +: 5
        __field vd_or_vs3 7 +: 5
        __field op 0 +: 7
        __opcode '000000101011xxxxx000xxxxxxxxxxxx'
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_vreg_backwards_matches(vd_or_vs3), encdec_lsop_backwards_matches(op))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VMVRTYPE_0
    __encoding VMVRTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_nreg_forwards_matches(nreg), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VSETIVLI_0
    __encoding VSETIVLI_0
        ...
        __guard and_bool(encdec_reg_backwards_matches(rd), currentlyEnabled(Ext_V))
        __decode
...
__instruction VSETVL_0
    __encoding VSETVL_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VSETVLI_0
    __encoding VSETVLI_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_V))
        __decode
...
__instruction VSHA2MS_VV_0
    __encoding VSHA2MS_VV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd))), or_bool(and_bool(currentlyEnabled(Ext_Zvknha), eq_int(get_sew(), 32)), and_bool(and_bool(currentlyEnabled(Ext_Zvknhb), or_bool(eq_int(get_sew(), 32), eq_int(get_sew(), 64))), zvknhab_check_encdec(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vs1), encdec_vreg_backwards(vd)))))
        __decode
...
__instruction VSM3C_VI_0
    __encoding VSM3C_VI_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), and_bool(currentlyEnabled(Ext_Zvksh), and_bool(eq_int(get_sew(), 32), and_bool(zvk_check_encdec(256, 8), zvk_valid_reg_overlap(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vd), get_lmul_pow())))))
        __decode
...
__instruction VSM3ME_VV_0
    __encoding VSM3ME_VV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd))), and_bool(currentlyEnabled(Ext_Zvksh), and_bool(eq_int(get_sew(), 32), and_bool(zvk_check_encdec(256, 8), zvk_valid_reg_overlap(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vd), get_lmul_pow())))))
        __decode
...
__instruction VSM4K_VI_0
    __encoding VSM4K_VI_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), and_bool(currentlyEnabled(Ext_Zvksed), and_bool(eq_int(get_sew(), 32), zvk_check_encdec(128, 4))))
        __decode
...
__instruction VSOXSEGTYPE_0
    __encoding VSOXSEGTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_vlewidth_backwards_matches(width), encdec_vreg_backwards_matches(vs3)))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VSRETYPE_0
    __encoding VSRETYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vs3)), currentlyEnabled(Ext_V))
        __decode
...
__instruction VSSEGTYPE_0
    __encoding VSSEGTYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_vlewidth_backwards_matches(width), encdec_vreg_backwards_matches(vs3))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VSSSEGTYPE_0
    __encoding VSSSEGTYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), and_bool(encdec_vlewidth_backwards_matches(width), encdec_vreg_backwards_matches(vs3)))), currentlyEnabled(Ext_V))
        __decode
...
__instruction VVCMPTYPE_0
    __encoding VVCMPTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx000xxxxx1010111'
        __guard and_bool(and_bool(encdec_vvcmpfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vvcmpfunct6 funct6 = encdec_vvcmpfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VVMCTYPE_0
    __encoding VVMCTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vvmcfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vvmcfunct6 funct6 = encdec_vvmcfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VVMSTYPE_0
    __encoding VVMSTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vvmsfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vvmsfunct6 funct6 = encdec_vvmsfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VVMTYPE_0
    __encoding VVMTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxx0xxxxxxxxxx000xxxxx1010111'
        __guard and_bool(and_bool(encdec_vvmfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vvmfunct6 funct6 = encdec_vvmfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VVTYPE_0
    __encoding VVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx000xxxxx1010111'
        __guard and_bool(and_bool(encdec_vvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vvfunct6 funct6 = encdec_vvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VWSLL_VV_0
    __encoding VWSLL_VV_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_Zvbb))
        __decode
...
__instruction VWSLL_VX_0
    __encoding VWSLL_VX_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd))), currentlyEnabled(Ext_Zvbb))
        __decode
...
__instruction VXCMPTYPE_0
    __encoding VXCMPTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx100xxxxx1010111'
        __guard and_bool(and_bool(encdec_vxcmpfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vxcmpfunct6 funct6 = encdec_vxcmpfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VXMCTYPE_0
    __encoding VXMCTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vxmcfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vxmcfunct6 funct6 = encdec_vxmcfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VXMSTYPE_0
    __encoding VXMSTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vxmsfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vxmsfunct6 funct6 = encdec_vxmsfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VXMTYPE_0
    __encoding VXMTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxx0xxxxxxxxxx100xxxxx1010111'
        __guard and_bool(and_bool(encdec_vxmfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vxmfunct6 funct6 = encdec_vxmfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VXSG_0
    __encoding VXSG_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx100xxxxx1010111'
        __guard and_bool(and_bool(encdec_vxsgfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vxsgfunct6 funct6 = encdec_vxsgfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction VXTYPE_0
    __encoding VXTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx100xxxxx1010111'
        __guard and_bool(and_bool(encdec_vxfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant vxfunct6 funct6 = encdec_vxfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction WMVVTYPE_0
    __encoding WMVVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx010xxxxx1010111'
        __guard and_bool(and_bool(encdec_wmvvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant wmvvfunct6 funct6 = encdec_wmvvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction WMVXTYPE_0
    __encoding WMVXTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx110xxxxx1010111'
        __guard and_bool(and_bool(encdec_wmvxfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant wmvxfunct6 funct6 = encdec_wmvxfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction WRS_0
    __encoding WRS_0
        ...
        __guard and_bool(encdec_wrsop_backwards_matches(op), currentlyEnabled(Ext_Zawrs))
        __decode
...
__instruction WVTYPE_0
    __encoding WVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx010xxxxx1010111'
        __guard and_bool(and_bool(encdec_wvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant wvfunct6 funct6 = encdec_wvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction WVVTYPE_0
    __encoding WVVTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx010xxxxx1010111'
        __guard and_bool(and_bool(encdec_wvvfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_vreg_backwards_matches(vs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant wvvfunct6 funct6 = encdec_wvvfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction WVXTYPE_0
    __encoding WVXTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx110xxxxx1010111'
        __guard and_bool(and_bool(encdec_wvxfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant wvxfunct6 funct6 = encdec_wvxfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction WXTYPE_0
    __encoding WXTYPE_0
        ...
        __field vd 7 +: 5
        __opcode 'xxxxxxxxxxxxxxxxx110xxxxx1010111'
        __guard and_bool(and_bool(encdec_wxfunct6_backwards_matches(funct6), and_bool(encdec_vreg_backwards_matches(vs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_vreg_backwards_matches(vd)))), currentlyEnabled(Ext_V))
        __decode


    __execute
        constant wxfunct6 funct6 = encdec_wxfunct6_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) rs1 = encdec_reg_backwards(rs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction XPERM4_0
    __encoding XPERM4_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zbkx))
        __decode
...
__instruction ZBA_RTYPE_0
    __encoding ZBA_RTYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zba))
        __decode
...
__instruction ZBA_RTYPEUW_0
    __encoding ZBA_RTYPEUW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zba), eq_int(xlen, 64)))
        __decode
...
__instruction ZBB_EXTOP_1
    __encoding ZBB_EXTOP_1
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_Zbb), eq_int(xlen, 32)))
        __decode
...
__instruction ZBB_RTYPE_0
    __encoding ZBB_RTYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), or_bool(currentlyEnabled(Ext_Zbb), currentlyEnabled(Ext_Zbkb)))
        __decode
...
__instruction ZBB_RTYPE_2
    __encoding ZBB_RTYPE_2
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zbb))
        __decode
...
__instruction ZBB_RTYPEW_0
    __encoding ZBB_RTYPEW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(or_bool(currentlyEnabled(Ext_Zbb), currentlyEnabled(Ext_Zbkb)), eq_int(xlen, 64)))
        __decode
...
__instruction ZBKB_PACKW_0
    __encoding ZBKB_PACKW_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), and_bool(currentlyEnabled(Ext_Zbkb), eq_int(xlen, 64)))
        __decode
...
__instruction ZBKB_RTYPE_0
    __encoding ZBKB_RTYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zbkb))
        __decode
...
__instruction ZBS_IOP_0
    __encoding ZBS_IOP_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), and_bool(currentlyEnabled(Ext_Zbs), or_bool(eq_int(xlen, 64), eq_bit(bitvector_access(shamt, 5), '0'))))
        __decode
...
__instruction ZBS_RTYPE_0
    __encoding ZBS_RTYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zbs))
        __decode
...
__instruction ZICBOM_0
    __encoding ZICBOM_0
        ...
        __guard and_bool(and_bool(encdec_cbop_backwards_matches(cbop), encdec_reg_backwards_matches(rs1)), currentlyEnabled(Ext_Zicbom))
        __decode
...
__instruction ZICBOZ_0
    __encoding ZICBOZ_0
        ...
        __guard and_bool(encdec_reg_backwards_matches(rs1), currentlyEnabled(Ext_Zicboz))
        __decode
...
__instruction ZICOND_RTYPE_0
    __encoding ZICOND_RTYPE_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zicond))
        __decode
...
__instruction ZIMOP_MOP_R_0
    __encoding ZIMOP_MOP_R_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd)), currentlyEnabled(Ext_Zimop))
        __decode
...
__instruction ZIMOP_MOP_RR_0
    __encoding ZIMOP_MOP_RR_0
        ...
        __guard and_bool(and_bool(encdec_reg_backwards_matches(rs2), and_bool(encdec_reg_backwards_matches(rs1), encdec_reg_backwards_matches(rd))), currentlyEnabled(Ext_Zimop))
        __decode
...
__instruction ZVKSHA2TYPE_0
    ...
    __execute
        constant zvk_vsha2_funct6 funct6 = encdec_vsha2_backwards(funct6);
        constant bits(5) vs2 = encdec_vreg_backwards(vs2);
        constant bits(5) vs1 = encdec_vreg_backwards(vs1);
        constant bits(5) vd = encdec_vreg_backwards(vd);
...
__instruction ZVKSM4RTYPE_0
    __encoding ZVKSM4RTYPE_0
        ...
        __guard and_bool(and_bool(encdec_vreg_backwards_matches(vs2), encdec_vreg_backwards_matches(vd)), and_bool(currentlyEnabled(Ext_Zvksed), and_bool(eq_int(get_sew(), 32), and_bool(zvk_check_encdec(128, 4), zvk_valid_reg_overlap(encdec_vreg_backwards(vs2), encdec_vreg_backwards(vd), get_lmul_pow())))))
        __decode
